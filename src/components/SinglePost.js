        ...
        <main className="bg-grey-200 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-green-100 rounded-lg">
                <header className="relative">
                    <div className="absolute h-full w-full flex items-center justify-center p-8">
                        <div className="bg-white bg-opacity-75 rounded p-12">
                            ...
                            <img src={urlFor(singlePost.authorImage).url()} alt={singlePost.name} className="rounded-full w-10 h-10"/>
                            </div>
                ...
                <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full">
                    <BlockContent blocks={singlePost.body} projectId="rfm6lkpk" dataset="production"></BlockContent>
                </div>
            </article>
        </main>
    )
